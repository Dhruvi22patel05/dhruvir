...
<body style="background-color:#f5f5f5">
  <div class="d-flex flex-row">
    ...
    <div>
      ...
      <div class="offcanvas offcanvas-start tw-bg-slate-200" style="background-color:#3d434f" data-bs-scroll="true" data-bs-backdrop="false" tabindex="-1"
        ...
        <input class="form-control h-75 mt-2" type="text" id="searchbar" placeholder="Search" aria-label="Search">
          ...
          <div class="accordion" id="accordionExample">
            <div class="accordion-item">
              <h2 class="accordion-header" id="headingOne">
                <button class="accordion-button text-dark fs-5" type="button" data-bs-toggle="collapse"
                  data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne"><span><img
                      src="../img/icons8-assignment-50.png" class="img-fluid me-2" alt="Assignmenticon"></span>
                  Assignments
                </button>
              </h2>
              <div id="collapseOne" class="accordion-collapse collapse searchcollapse" aria-labelledby="headingOne"
                data-bs-parent="#accordionExample">
                <div class="accordion-body">
                  <ul class="list-group">
                    <li class="list-group-item" id="a1">JS_Calculator</li>
                    <li class="list-group-item" id="a2">Date Validation</li>
                    <li class="list-group-item" id="a3">Employee Form</li>
                    <li class="list-group-item" id="a4">JS_Timer</li>
      ...
      <nav class="navbar navbar-expand-lg navbar-custom">
        ...
        <div class="collapse navbar-collapse hoverable" id="navbarSupportedContent">
          <ul class="navbar-nav ms-auto mb-2 mb-lg-0 me-4">
            ...
            <li class="nav-item">
              <a class="nav-link text-light" href="index.php">Javascript</a>
            </li>
            <li class="nav-item">
